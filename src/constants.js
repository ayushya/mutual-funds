...
export const GET_FUNDS = (schemePlan) => `${SERVER_API_URL}/insight/api/v1/mutual_fund_search.json?limit=10000&scheme_plan=${schemePlan}&order_by=desc&v=${moment().dayOfYear()}`;
